        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Users | Clients</li>
                </ol>
            </div>
        </div>
    </div>
          ...
          @endif
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('user.create') }}" class="btn btn-primary float-right">Create Clients</a>
                    </div>
...
<input type="hidden" id="ajaxroute" name="ajaxroute" value="{{ route('user.ajaxTable') }}" />
