	...
	<table style="    width: 100%; border-spacing: 0px; border: 1px solid #dfdfdf;">
		<thead style="background:#0e0e64; color: white;">
			...
			<tr style="background: white; height: 40px">
				<td><input style="width: 30px;" type="text" name="sn" id="" class="" value="{{ $bill->sn }}" readonly></td>
				<td><input style="width: 600px;" type="text" name="name" id="" class="" value="{{ $bill->name }}" readonly></td>
				<td><input style="width: 100px;" type="text" name="price" id="price" value="{{ $bill->price }}" readonly></td>
				<td><input style="width: 50px;" type="text" name="quantity" id="quantity"  value="{{ $bill->quantity }}" readonly></td>
				<td><input style="width: 100px;" type="text" name="total" id="total"  value="{{ $bill->total }}" readonly></td>
				
			</tr>
			<tr style="background: #e5e6e9; height: 40px">
			    <td><input style="width: 30px;" type="text" name="sn_one" id="" class="" value="{{ $bill->sn_one }}" readonly></td>
				<td><input style="width: 600px;" type="text" name="name_one" id="" class="" value="{{ $bill->name_one }}"readonly></td>
				<td><input style="width: 100px;" type="text" name="price_one" id="price_one" value="{{ $bill->price_one }}" readonly></td>
				<td><input style="width: 50px;" type="text" name="quantity_one" id="quantity_one" value="{{ $bill->quantity_one }}" readonly></td>
				<td><input style="width: 100px;" type="text" name="total_one" id="total_one" value="{{ $bill->total_one }}" readonly></td>
				
			</tr>
			<tr style="background: white; height: 40px">
                <td><input style="width: 30px;" type="text" name="sn_two" id="" class="" value="{{ $bill->sn_two }}"  readonly></td>
				<td><input style="width: 600px;" type="text" name="name_two" id="" class="" value="{{ $bill->name_two }}"readonly></td>
				<td><input style="width: 100px;" type="text" name="price_two" id="price_two" value="{{ $bill->price_two }}" readonly></td>
				<td><input style="width: 50px;" type="text" name="quantity_two" id="quantity_two" value="{{ $bill->quantity_two }}" readonly></td>
				<td><input style="width: 100px;" type="text" name="total_two" id="total_two" value="{{ $bill->total_two }}" readonly></td>
				
			</tr>
			<tr style="background: #e5e6e9; height: 40px">
                <td><input style="width: 30px;" type="text" name="sn_three" id="" class="" value="{{ $bill->sn_three }}" readonly ></td>
				<td><input style="width: 600px;" type="text" name="name_three" id="" class="" value="{{ $bill->name_three }}"readonly></td>
				<td><input style="width: 100px;" type="text" name="price_three" id="price_three" value="{{ $bill->price_three }}" readonly></td>
				<td><input style="width: 50px;" type="text" name="quantity_three" id="quantity_three" value="{{ $bill->quantity_three }}" readonly></td>
				<td><input style="width: 100px;" type="text" name="total_three" id="total_three" value="{{ $bill->total_three }}" readonly></td>
				
			</tr>
			<tr style="background: white; height: 60px">
                <td><input style="width: 30px;" type="text" name="sn_four" id="" class="" value="{{ $bill->sn_four }}"  readonly></td>
				<td><input style="width: 600px;" type="text" name="name_four" id="" class="" value="{{ $bill->name_four }}"readonly></td>
				<td><input style="width: 100px;" type="text" name="price_four" id="price_four" value="{{ $bill->price_four }}" readonly></td>
				<td><input style="width: 50px;" type="text" name="quantity_four" id="quantity_four" value="{{ $bill->quantity_four }}" readonly ></td>
				<td><input style="width: 100px;" type="text" name="total_four" id="total_four" value="{{ $bill->total_four }}" readonly></td> 
...
<div class="box" style="width:100%; height:5rem;">
	...
	<p>Sub Total : <input style="width: 100px;" type="text" name="sub_total" id="sub_total"  value="{{ $bill->sub_total }}" readonly> </p>
		<p>Vat (13%) : <input style="width: 100px;" type="text" name="vat" id="vat" value="{{ $bill->vat }}" readonly > </p>
		<br>
		<p style="background: orange; padding: 10px;">Total : <input style="width: 100px;" type="text" name="all_total" id="all_total"  value="{{ $bill->all_total }}" readonly> </p>
