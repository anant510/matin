...
<form action="{{ route('bill.get_data',[$user->id]) }}" method="post">
    @csrf
...
<div class="container" style="height: 8rem;">
	<div style="width: 65%; float: left;">
		<h2>Invoice to : </h2>
		<p style="margin-top: 13px;">Name : {{ $user->name }} </p>
		<p>Phone : {{ $user->phone }}</p>
		<p>Address : {{ $user->address }}</p>
	</div>
<div style="width: 30%; float: right; padding-top: 20px;">
	<p style="margin-top: 43px;">Invoice No. : MS{{ $user->id }}</p>
		<p name="date">Date : <input type="text" name="date" id="" value="{{ date("Y-m-d") }}" readonly> </p>
        <p>Staus:</p>
	...
	<table style="    width: 100%; border-spacing: 0px; border: 1px solid #dfdfdf;">
		<thead style="background:#0e0e64; color: white;">
			...
			<tr style="background: white; height: 40px">
				<td><input style="width: 30px;" type="text" name="sn" id="" class="" value="{{ ++$total }}" readonly></td>
				<td><input style="width: 600px;" type="text" name="name" id="" class=""></td>
				<td><input style="width: 100px;" type="text" name="price" id="price" ></td>
				<td><input style="width: 50px;" type="text" name="quantity" id="quantity" ></td>
				<td><input style="width: 100px;" type="text" name="total" id="total" ></td>
				
			</tr>
			<tr style="background: #e5e6e9; height: 40px">
			    <td><input style="width: 30px;" type="text" name="sn_one" id="" class="" value="{{ ++$total }}" readonly></td>
				<td><input style="width: 600px;" type="text" name="name_one" id="" class=""></td>
				<td><input style="width: 100px;" type="text" name="price_one" id="price_one"></td>
				<td><input style="width: 50px;" type="text" name="quantity_one" id="quantity_one"></td>
				<td><input style="width: 100px;" type="text" name="total_one" id="total_one"></td>
				
			</tr>
			<tr style="background: white; height: 40px">
                <td><input style="width: 30px;" type="text" name="sn_two" id="" class="" value="{{ ++$total }}" readonly></td>
				<td><input style="width: 600px;" type="text" name="name_two" id="" class=""></td>
				<td><input style="width: 100px;" type="text" name="price_two" id="price_two" ></td>
				<td><input style="width: 50px;" type="text" name="quantity_two" id="quantity_two" ></td>
				<td><input style="width: 100px;" type="text" name="total_two" id="total_two" ></td>
				
			</tr>
			<tr style="background: #e5e6e9; height: 40px">
                <td><input style="width: 30px;" type="text" name="sn_three" id="" class="" value="{{ ++$total }}"readonly ></td>
				<td><input style="width: 600px;" type="text" name="name_three" id="" class=""></td>
				<td><input style="width: 100px;" type="text" name="price_three" id="price_three" ></td>
				<td><input style="width: 50px;" type="text" name="quantity_three" id="quantity_three" ></td>
				<td><input style="width: 100px;" type="text" name="total_three" id="total_three" ></td>
				
			</tr>
			<tr style="background: white; height: 60px">
                <td><input style="width: 30px;" type="text" name="sn_four" id="" class="" value="{{ ++$total }}" readonly></td>
				<td><input style="width: 600px;" type="text" name="name_four" id="" class=""></td>
				<td><input style="width: 100px;" type="text" name="price_four" id="price_four" ></td>
				<td><input style="width: 50px;" type="text" name="quantity_four" id="quantity_four" ></td>
				<td><input style="width: 100px;" type="text" name="total_four" id="total_four" ></td> 
...
<div class="box" style="width:100%; height:5rem;">
	...
	<p>Sub Total : <input style="width: 100px;" type="text" name="sub_total" id="sub_total" > </p>
		<p>Vat (13%) : <input style="width: 100px;" type="text" name="vat" id="vat" > </p>
		<br>
		<p style="background: orange; padding: 10px;">Total : <input style="width: 100px;" type="text" name="all_total" id="all_total" > </p>
