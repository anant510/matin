          ...
          @endif
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('product_category.create') }}" class="btn btn-primary float-right">Create Product Category</a>
                    </div>
...
<input type="hidden" id="ajaxroute" name="ajaxroute" value="{{ route('product_category.ajaxTable') }}" />
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on('click', '.rowDelete', function() {
                ...
                var url = "{{ route('product_category.delete') }}";
                swal({
                        title: "Are you sure?",
