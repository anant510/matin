          ...
          @endif
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('agreement.create') }}" class="btn btn-primary float-right">Create Agreement</a>
                    </div>
...
<input type="hidden" id="ajaxroute" name="ajaxroute" value="{{ route('agreement.ajaxTable') }}" />
