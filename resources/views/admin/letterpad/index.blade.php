        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Letterpad</li>
                </ol>
            </div>
        </div>
    </div>
          ...
          @endif
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('letterpad.create') }}" class="btn btn-primary float-right">Create Letterpad</a>
                    </div>
...
<input type="hidden" id="ajaxroute" name="ajaxroute" value="{{ route('letterpad.ajaxTable') }}" />
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on('click', '.rowDelete', function() {
                ...
                var url = "{{ route('letterpad.delete') }}";
                swal({
                        title: "Are you sure?",
