          ...
          @endif
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('product.create') }}" class="btn btn-primary float-right">Create Product</a>
                    </div>
...
<input type="hidden" id="ajaxroute" name="ajaxroute" value="{{ route('product.ajaxTable') }}" />
