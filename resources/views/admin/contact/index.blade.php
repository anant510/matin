          ...
          @endif
                <div class="card">
                    <div class="card-header">
                        ...
                        <!-- <a href="{{ route('lead.create') }}" class="btn btn-primary float-right">Create TIcket</a> -->
                    </div>
...
<input type="hidden" id="ajaxroute" name="ajaxroute" value="{{ route('contact.ajaxTable') }}" />
